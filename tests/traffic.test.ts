...
describe('Traffic Management', () => {
    ...
    it('should successfully limit aggregate upstream speed', async () => {
        const config1 = new Config('127.0.0.1', 1787);
        config1.thisPort = 1900;
        ...
        for (let i = 0; i < NUMBER_REQUESTS; i++) {
            let dest: PeerNode = peerNodes.getPeerNode('127.0.0.1', 1901);
