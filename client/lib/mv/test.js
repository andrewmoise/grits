export const tests = [
  {
    ...
    async fn(shell, scratch) {
      ...
      await shell.eval(`gsh.p('${scratch}/src.txt').mv(gsh.p('${scratch}/dest.txt'))`);
  ...
  },
  {
    ...
    async fn(shell, scratch) {
      await shell.eval(`gsh.p('${scratch}/src.txt').w('hello')`);
      await shell.eval(`gsh.p('${scratch}/dest.txt').w('world')`);
      let threw = false;
      try {
        await shell.eval(`gsh.p('${scratch}/src.txt').mv(gsh.p('${scratch}/dest.txt'))`);
      } catch (e) {
  ...
  },
  {
    ...
    async fn(shell, scratch) {
      await shell.eval(`gsh.p('${scratch}/src.txt').w('hello')`);
      await shell.eval(`gsh.p('${scratch}/dest.txt').w('world')`);
      await shell.eval(`gsh.p('${scratch}/src.txt').mv(gsh.p('${scratch}/dest.txt'), {f:1})`);
      const text = await shell.eval(`gsh.p('${scratch}/dest.txt').read()`);
      if (text !== 'hello') throw new Error(`expected 'hello' at dest, got '${text}'`);
    },
  },
  {
    ...
    async fn(shell, scratch) {
      await shell.eval(`gsh.p('${scratch}/src.txt').w('x')`);
      let threw = false;
      try {
        await shell.eval(`gsh.p('${scratch}/src.txt').read().mv(gsh.p('${scratch}/dest.txt'))`);
      } catch (e) {
  ...
  },
  {
    ...
    async fn(shell, scratch) {
      await shell.eval(`gsh.p('${scratch}/dir1').mkdir()`);
      await shell.eval(`gsh.p('${scratch}/src.txt').w('hello')`);
      await shell.eval(`gsh.p('${scratch}/src.txt').mv(gsh.p('${scratch}/dir1'))`);
      const text = await shell.eval(`gsh.p('${scratch}/dir1/src.txt').read()`);
  ...
  },
  {
    ...
    async fn(shell, scratch) {
      await shell.eval(`gsh.p('${scratch}/dir2').mkdir()`);
      await shell.eval(`gsh.p('${scratch}/src.txt').w('hello')`);
      await shell.eval(`gsh.p('${scratch}/src.txt').mv(gsh.p('${scratch}/dir2'), {f:1})`);
      const text = await shell.eval(`gsh.p('${scratch}/dir2/src.txt').read()`);
      if (text !== 'hello') throw new Error('file not moved into directory');
    },
  },
  {
    ...
    async fn(shell, scratch) {
      await shell.eval(`gsh.p('${scratch}/dir3').mkdir()`);
      await shell.eval(`gsh.p('${scratch}/src.txt').w('hello')`);
      await shell.eval(`gsh.p('${scratch}/src.txt').mv(gsh.p('${scratch}/dir3'), {ff:1})`);
      const text = await shell.eval(`gsh.p('${scratch}/dir3').read()`);
  ...
  },
  {
    ...
    async fn(shell, scratch) {
      await shell.eval(`gsh.p('${scratch}/src.txt').w('hello')`);
      await shell.eval(`gsh.p('${scratch}/src.txt').mv(gsh.p('${scratch}/dest'), {f:1})`);
      const text = await shell.eval(`gsh.p('${scratch}/dest').read()`);
