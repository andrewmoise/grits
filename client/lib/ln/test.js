...
export const tests = [
  {
    ...
    async fn(shell, scratch) {
      await shell.eval(`ln(':client/lib/echo/main.js', '${scratch}/echo.js')`);
  ...
  },
  {
    ...
    async fn(shell, scratch) {
      ...
      await shell.eval(`ln(':client/lib/echo/main.js', '${scratch}/subdir1')`);
  ...
  },
  {
    ...
    async fn(shell, scratch) {
      let threw = false;
      try {
        await shell.eval(`ln(':client/lib/echo/main.js', '${scratch}/notadir/')`);
      } catch (e) {
  ...
  },
  {
    ...
    async fn(shell, scratch) {
      ...
      await shell.eval(`ln(':client/lib/echo/main.js', '${scratch}/subdir2/')`);
  ...
  },
  {
    ...
    async fn(shell, scratch) {
      await shell.eval(`ln(':client/lib/echo/main.js', '${scratch}/main.js')`);
      await shell.eval(`ln(':client/lib/cat/main.js', '${scratch}/main.js')`);
  ...
  },
  {
    ...
    async fn(shell, scratch) {
      ...
      await shell.eval(`ln(':client/lib/echo/main.js', '${scratch}/subdir3/', {i:1})`);
      ...
      await shell.eval(`ln(':client/lib/cat/main.js', '${scratch}/subdir3/main.js')`);
  ...
  },
  {
    ...
    async fn(shell, scratch) {
      ...
      let threw = false;
      try {
        await shell.eval(`ln(':client/lib/echo/main.js', '${scratch}/echo.js', {i:1})`);
      } catch (e) {
        if (e.message.includes('already exists')) threw = true;
        else throw e;
      }
  ...
  },
  {
    ...
    async fn(shell, scratch) {
      await shell.eval(`ln(':client/lib/echo/main.js', '${scratch}/fresh.js', {i:1})`);
  ...
  },
  {
    ...
    async fn(shell, scratch) {
      let threw = false;
      try {
        await shell.eval(`from(':client/lib/echo/main.js').ln('${scratch}/out.js')`);
      } catch (e) {
